...
Public Function ASSIGN_LONG_VAL_BYTE_EEHNSE(in_long_val As Long) As ExtExcptnHandlngNumStatesEnum
    ...
    ElseIf (in_long_val = NEGATIVE_MAX_LONG_VAL) Then
        result = NEGATIVE_MAX_EEHNSE
    ElseIf (in_long_val = NEGATIVE_INFINITY_LONG_VAL) Then
        result = NEGATIVE_INFINITY_EEHNSE
    ElseIf (in_long_val = EPSILON_LONG_VAL) Then
        result = EPSILON_EEHNSE
    ElseIf (in_long_val = NEGATIVE_EPSILON_LONG_VAL) Then
