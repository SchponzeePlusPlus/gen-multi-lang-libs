...
Public Const NULL_LONG_VAL As Long = -9223372036854775700
'   Actual default
Public Const DEFAULT_LONG_VAL As Long = 0
Public Const UNASSIGNED_LONG_VAL As Long = -9223372036854775699
Public Const UNKNOWN_LONG_VAL As Long = -9223372036854775698
Public Const UNCATEGORISED_LONG_VAL As Long = -9223372036854775697
Public Const UNDEFINED_LONG_VAL As Long = -9223372036854775696
Public Const ERROR_LONG_VAL As Long = -9223372036854775695
Public Const ERROR_NAME_LONG_VAL As Long = -9223372036854775694
Public Const ERROR_NUM_LONG_VAL As Long = -9223372036854775693
Public Const ERROR_NUM_DIV_ZERO_LONG_VAL As Long = -9223372036854775692
Public Const ERROR_NUM_UNDEFINED_LONG_VAL As Long = -9223372036854775691
Public Const ERROR_REF_LONG_VAL As Long = -9223372036854775690
Public Const NOT_AVAIL_LONG_VAL As Long = -9223372036854775689
Public Const NOT_APPLICABLE_LONG_VAL As Long = -9223372036854775688
Public Const MISC_LONG_VAL As Long = -9223372036854775687
Public Const OTHER_LONG_VAL As Long = -9223372036854775686
Public Const TEST_LONG_VAL As Long = -9223372036854775685
Public Const MULTI_VAL_LONG_VAL As Long = -9223372036854775684
Public Const ALL_VAL_LONG_VAL As Long = -9223372036854775683
Public Const VALID_LONG_VAL As Long = -9223372036854775682
...
Public Const NEGATIVE_EPSILON_LONG_VAL As Long = -9223372036854775681
Public Const EPSILON_LONG_VAL As Long = -9223372036854775680
Public Const INFINITY_LONG_VAL As Long = 9223372036854775806
Public Const MAX_LONG_VAL As Long = 9223372036854775807

'   Now that error / exception handling "codes" have taken up specific integer values
'   , those values shouldn't be usable for other means such as ordinary calculations or variable assignment
Public Const USABLE_UPPER_BOUNDARY_INTEGER_VAL As Integer = 9223372036854775805
Public Const USABLE_LOWER_BOUNDARY_INTEGER_VAL As Integer = -9223372036854775679
